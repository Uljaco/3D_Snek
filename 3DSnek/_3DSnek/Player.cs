...
namespace _3DSnek
{
    class Player
    {
        Vector3 playerCoords { get; set; }   //xyz coordinates, maybe just need xy if we keep z uniform, but keeping in 3d vector might make it easier to compute?
